...
- Being kind and patient, especially with people new to Swift or to macOS.
- Giving and gracefully accepting constructive feedback on code.
- Focusing on what is best for the project and its users.
- Assuming good faith. English is not everyone's first language.
...
and the reporter's privacy and security will be respected.
